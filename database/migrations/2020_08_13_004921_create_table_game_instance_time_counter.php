...
class CreateTableGameInstanceTimeCounter extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('game_instance_time_counter', function (Blueprint $table) {
            ...
            $table->date('date')->comment('Fecha de tiempo acumulado');
            $table->bigInteger('time_used')->comment('Tiempo acumulado usado');
