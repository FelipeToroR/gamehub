...
<div class="form-group col-sm-12">
    ...
    {!! Form::select('game_parameter_id', $gameParameterItems, null, ['class' => 'form-control', 'disabled' => 'disabled']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{{ route('experiments.game-instances.parameters.index',[$experiment_id, $game_instance_id] ) }}" class="btn btn-default">Cancel</a>
</div>
